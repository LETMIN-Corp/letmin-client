...
const AdminCompanyVacancyCard: React.FC<ComponentInterface> = ({ vacancy }) => {
    let currency = <FontAwesomeIcon icon={faMoneyBill} className="mr-1" />;
...
export default AdminCompanyVacancyCard;
