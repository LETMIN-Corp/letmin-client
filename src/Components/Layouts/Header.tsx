...
const Header : React.FC = () => {
    ...
    const ExistJustOneButton = pageButtons[pagePath].length === 1;
                                    ...
                                    <div className='text-center mt-20 md:mt-0 md:flex md:p-1'>
                                        {
                                            pageButtons[pagePath].map((button : ButtonsInterface) => {
                                                ...
                                                return (
                                                    <a
                                                        className='block text-lg md:text-xl mb-12 md:mb-0 md:flex items-center text-black md:text-lg md:mr-5 hover:text-primary ease-out duration-200'
                                                        href={ button.path }
                                                        key={ button.path }
                                                        onClick={ () => setMenuIsOpen(false) }
                                                    >
