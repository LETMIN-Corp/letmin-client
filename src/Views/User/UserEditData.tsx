                    ...
                    <main>
                        ...
                        <div className="relative md:justify-end mx-5">
                            <div className="mt-24 md:mt-5 text-lg flex items-center">
                                ...
                                <FontAwesomeIcon
                                    icon={faPencil}
                                    className="rounded-full border-4 border-lively-purple text-white bg-lively-purple ml-28 p-3 z-10"
                                />
                            ...
                            <div>
                                {userData.experiences.length != 0 && (
                                    <button
                                        ...
                                        className="bg-red w-10 h-10 mr-3 rounded-md text-white hover:bg-dark-red ease-out duration-200"
                                    >
                                        <FontAwesomeIcon
                                            icon={
                                ...
                                <button
                                    ...
                                    className="bg-primary w-10 h-10 mr-3 rounded-md text-white hover:bg-dark-purple ease-out duration-200"
                                >
                        ...
                        <div className="mx-5">
                            ...
                            {modalSaveConfirmationIsOpen && (
                                <ConfirmationModal
                                    ...
                                    handleClose={() =>
                                        setModalSaveConfirmationIsOpen(false)
                                    }
