                    ...
                    <div className='min-h-90'>
                        <main>
                                ...
                                <div className='mt-5 mx-5 font-medium'>
                                    ...
                                    <div>
                                        <div className='w-full md:flex justify-between'>
                                            <TextInput size='large' placeholder='Nome' type='text' name='name' id='userName' consultPackage={ consultPackage } /> 
                                            <TextInput size='medium' placeholder='Cargo' type='text' name='role' id='userRole' consultPackage={ consultPackage } /> 
                                        </div>
                                        <div>
                                ...
                                <div className='mt-24 md:my-4 flex justify-between items-center w-full mb-2'>
                                    ...
                                    <div>
                                    {
                                        (userData.experiences.length != 0) && (
                                            <button onClick={ () => flipExclude('experiences') } className='bg-red w-10 h-10 mr-2 rounded-md text-white hover:bg-dark-red ease-out duration-200'>
                                    ...
                                    { modalExcludeExperienceIsOpen && <ConfirmationModal title='Excluir esta experiência' text='Você realmente excluir esta experiência?' handleClose={ () => setModalExcludeExperienceIsOpen(false) } handleConfirm={ approveExclusion } /> }
                                        ...
                                        <button onClick={ () => setXPModalIsOpen(true) } className='bg-primary w-10 h-10 rounded-md text-white hover:bg-dark-purple ease-out duration-200'>
                                ...
                                <div className='mt-24 md:my-4 flex justify-between items-center w-full mb-2'>
                                    ...
                                    <div>
                                    {
                                        (userData.formations.length != 0) && (
                                            <button onClick={ () => flipExclude('formations') } className='bg-red w-10 h-10 mr-2 rounded-md text-white hover:bg-dark-red ease-out duration-200'>
                                                <FontAwesomeIcon icon={ canExclude.formations ? faTrashArrowUp : faTrash } />
                                            </button>
                                        )
                                    }   
                                        <button onClick={ () => setFormationModalIsOpen(true) } className='bg-primary w-10 h-10 rounded-md text-white hover:bg-dark-purple ease-out duration-200'>
                                            <FontAwesomeIcon icon={ faPlus } />
                                        </button>
                                        {
                            ...
                            <div className='md:ml-3 my-5 flex justify-between md:justify-end w-full px-5'>                            
                                <div className='mr-2'>
                                    <FormButton isDanger={ true } text='Cancelar' handleClick={ () => setModalExitIsOpen(true) } />
                                </div>
