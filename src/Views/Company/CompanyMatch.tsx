                ...
                <div className="xl:flex h-2/3 justify-around mt-5">
                    <div className="xl:flex xl:items-center w-full xl:w-1/3">
                        <div className="px-3 py-4 w-full">
                            <img src={Combine} className="md:h-80 lg:h-full m-auto" alt="" />
                            <div className="font-bold text-dark-purple text-lg">Pedro Antonio da Silva</div>
                            <div className="font-medium lg:text-lg text-justify">
                                Sou um Designer de Interiores, que estagiou durante o ano de 2018 na empresa INSIDE -
                                Arquitetura e Design de Interiores na cidade de São Paulo. Meus projetos se baseiam no
                                estilo gregoriano moderno, onde mesclo tradição e história com tecnologia e inovação.
                            </div>
                        </div>
                    </div>
