                        ...
                        <>
                            ...
                            <form className='mb-10 lg:w-8/12 lg:mx-auto'>
                                <div className='md:flex justify-between w-full'>
                                    <TextInput required={ true } placeholder='Razão Social' size='large' limit={ 64 } type={ InputTypesEnum.text } consultPackage={ consultPackage } name='company-name' id='company-name' />
                            ...
                            <form className='lg:w-8/12 lg:mx-auto'>
                                <div className='md:flex justify-between w-full'>
                                    <TextInput required={ true } placeholder='Nome do Titular' size='large' limit={ 64 } useMask={ MaskTypesEnum.holder } type={ InputTypesEnum.text } consultPackage={ consultPackage } name='holder-name' id='holder-name' />
                                ...
                                <TextInput required={ true } placeholder='Confirmar Senha' limit={ 128 } type={ InputTypesEnum.password } consultPackage={ consultPackage } name='holder-confirmPassword' id='holder-confirmPassword' />
                            </form>
                        </>
                    )
                }
                    ...
                    (currentPage === 2) && (
                        <>
                            ...
                            <form className='mb-10 lg:w-8/12 lg:mx-auto'>
                                ...
                                <TextInput required={ true } placeholder='Número do Cartão' type={ InputTypesEnum.text } consultPackage={ consultPackage } useMask={ MaskTypesEnum.cardNumber } name='card-number' id='card-number' />
                        ...
                        <>
                            ...
                            <div>
                                ...
                                <form className='mb-10 lg:w-8/12 lg:mx-auto'>
                                    ...
                                    <div className='md:flex justify-between w-full'>
                                        <TextInput required={ true } placeholder='Data de Vencimento' size='medium' type={ InputTypesEnum.text } consultPackage={ viewConsultPackage } name='card-expiration' disabled={ true }/>
                                        <TextInput required={ true } placeholder='CVV' size='small' type={ InputTypesEnum.text } consultPackage={ viewConsultPackage } name='card-code' disabled={ true }/>
