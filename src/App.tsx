        ...
        <div className="w-screen min-h-screen relative">
            <Routes>
                <Route element={<PublicRoutes />}>
                    ...
                    <Route
                        path="/company/recover-password"
                        element={<CompanyRecoverPassword />}
                    />
                    <Route
                        path="/company/new-password"
                        element={<CompanyPasswordDefinition />}
                    />
                </Route>
                <Route element={<PrivateRoutes roles={[RoleEnum.Company]} />}>
                    ...
                    <Route
                        path="/company/talents/search"
                        element={<CompanyTalentSearch />}
                    />
                    <Route
                        path="/company/vacancy/:id"
                        element={<CompanyVacancyDetail />}
                    />
                    <Route
                        path="/company/vacancy/data/:id"
                        element={<CompanyVacancyData />}
                    />
                    <Route path="/company/combinations" element={<CompanyMatch />} />
                    <Route
                        path="/company/combinations/:id"
                        element={<CompanyCombinations />}
                    />
                    <Route
                        path="/company/register/vacancy"
                        element={<CompanyRegisterVacancy />}
                    />
                ...
                <Route element={<PrivateRoutes roles={[RoleEnum.Admin]} />}>
                    ...
                    <Route
                        path="/admin/combinations/:id"
                        element={<AdminCombinations />}
                    />
                </Route>
            </Routes>
            <CookiesPopUp />
